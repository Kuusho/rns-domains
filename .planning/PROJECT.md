...
- [ ] Convenience layer — `BatchGatewayProvider` + `UniversalResolver`, `StaticBulkRenewal` (Phase 7, optional)
- [ ] Subdomain wrapping — `NameWrapper` + `ERC1155Fuse` + `StaticMetadataService` (Phase 8, optional)
